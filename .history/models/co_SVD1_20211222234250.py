...
class SVD:
    ...
    def train(self, dataset, is_train, nb_epochs, weight1, use_weight=True):
        ...
        for cur_epochs in range(nb_epochs):
            ...
            hr,hr1, ndcg = utils1.train_evalute(rate, dataset, cur_epochs)
        return hr,hr1, ndcg
    ...
    def get_label(self, rate1, rate2):
        ...
        # mask1 = np.random.binomial(1,0.5,self.dataset.trainMatrix.toarray().shape)
        rate = (pred111 + 1e-5) * rate_mask
        # print(rate)
